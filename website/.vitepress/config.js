...
const menuItems = [
  ...
  { text: 'Codec Names', link: '/names' },
  { text: 'Codec Options', link: '/options' },
  { text: 'Chaining Codecs', link: '/chaining' },
  { text: 'Adding Codecs', link: '/adding' },
]

// https://vitepress.dev/reference/site-config
export default defineConfig({
  title: "Badger Codecs",
  description: "Encode blah ",
  head: [['link', { rel: 'icon', href: '/badger-codecs-js/images/badger3.svg' }]],
  base: '/badger-codecs-js/',
  outDir: '../docs',
  lastUpdated: true,
  themeConfig: {
    siteTitle: 'Badger Codecs',
    ...
    socialLinks: [
      ...
      { icon: 'github', link: 'https://github.com/abw/badger-codecs-js' }
    ],
    footer: {
